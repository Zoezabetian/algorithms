...
private:
 enum Color { RED, BLACK };  // added this enumeration for color
 ...
 struct Node {
   ...
   Node(keyType k, valType v);
    ...
    // preOrderCopy()
    // Recursively inserts a deep copy of the subtree rooted at R into this Dictionary. Recursion terminates at N.
    Node *preOrderCopy(Node* src);
